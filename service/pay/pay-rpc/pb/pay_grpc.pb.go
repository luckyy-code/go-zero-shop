...
const (
	...
	Pay_Detail_FullMethodName   = "/pb.pay/Detail"
	Pay_Callback_FullMethodName = "/pb.pay/Callback"
)
...
func (c *payClient) Detail(ctx context.Context, in *DetailRequest, opts ...grpc.CallOption) (*DetailResponse, error) {
	...
	err := c.cc.Invoke(ctx, Pay_Detail_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *payClient) Callback(ctx context.Context, in *CallbackRequest, opts ...grpc.CallOption) (*CallbackResponse, error) {
	...
	err := c.cc.Invoke(ctx, Pay_Callback_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
